...
export const getProduct = createAsyncThunk("user/getProduct", async (type) => {
  // let query = `page=${payload.page}&limit=${payload.limit}`;
  const response = await productApi.getAllProduct(type);
...
export const updateProducts = createAsyncThunk(
  "user/updatePro",
  async (payload) => {
    const response = await productApi.editProduct(payload);
    return response;
  }
);
...
export const deleteProducts = createAsyncThunk(
  "user/deleteProducts",
  async (payload) => {
    const response = await productApi.deleteProducts(payload);
    return response;
  }
);
