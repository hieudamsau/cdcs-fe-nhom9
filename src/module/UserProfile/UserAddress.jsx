        ...
        <div className="overflow-y-auto h-[650px] px-10 py-5 ">
          ...
          <form onSubmit={handleSubmit(handleSend)} autoComplete="off">
            ...
            <div className="flex items-center justify-end gap-x-4 mt-5">
              <button
                className="p-3 text-red-500 font-medium bg-white  rounded-lg border border-solid border-[red]"
                type="button"
              ...
              <button
              className="p-3  font-medium bg-white rounded-lg border border-solid border-[blue] text-[#316BFF]"
                height="50px"
                type="submit"
