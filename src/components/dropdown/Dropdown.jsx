...
const Dropdown = () => {
  ...
  const handleLogout = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        await localStorage.removeItem("asses_token");
        navigate("/");
  ...
  return (
    <DropdownStyles className="dropdown">
      ...
      {
        user?.role == 0 ? (<NavLink to="/account/orders" end>
          <div className="flex items-center gap-x-4 border-b-2 border-solid px-3 py-2">
            ...
            <span className="text-base font-medium">Đơn hàng của tôi</span>
          </div>
        </NavLink>)
          : (<></>)
      }
...
{
        user?.role == 1 ? (<NavLink to="/admin/users" end>
          <div className="flex items-center gap-x-4 border-b-2 border-solid px-3 py-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <span className="text-base font-medium">Quản lý tài khoản nhân viên</span>
          </div>
        </NavLink>)
          : (<></>)
      }
...
{
        user?.role == 1 ? (<NavLink to="admin/accountOrders" end>
          <div className="flex items-center gap-x-4 border-b-2 border-solid px-3 py-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <span className="text-base font-medium">Thống kê doanh thu</span>
          </div>
        </NavLink>)
          : (<></>)
      }
      {
        user?.role == 1 ? (<NavLink to="/admin/product" end>
          <div className="flex items-center gap-x-4 border-b-2 border-solid px-3 py-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <span className="text-base font-medium">Quản lý sản phẩm</span>
          </div>
        </NavLink>)
          : (<></>)
      }
